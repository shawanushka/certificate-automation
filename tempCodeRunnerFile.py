...
NAME_X = 470  # I increased this from 340 to help center it
NAME_Y = 290  # Up/Down

# --- 2. FONT SETTINGS ---
# Options: "Helvetica-Bold", "Times-Bold", "Courier-Bold"
#FONT_NAME = "Agrandir-Narrow"
FONT_NAME= ImageFont.truetype("fonts/Agrandir-Narrow.otf", 48)
START_FONT_SIZE = 48         # Starting size
MINIMUM_FONT_SIZE = 12          # Won't shrink smaller than this
MAX_WIDTH_ALLOWED = 300       # If wider than this, shrink logic starts
